...
def main() -> int:
    ...
    parser.add_argument("--default-wait-seconds", type=int, default=1800)
...
def sample_from_trade_setup_row(row: Mapping[str, Any], *, default_wait_seconds: int = 1800) -> SetupSample | None:
