...
OUTCOME_RECONCILE_UNIT_PATH="/etc/systemd/system/binance-futures-agent-outcome-reconcile.service"
OUTCOME_RECONCILE_TIMER_PATH="/etc/systemd/system/binance-futures-agent-outcome-reconcile.timer"
...
require_isolated_paths() {
  ...
  [ "$OUTCOME_RECONCILE_UNIT_PATH" = "/etc/systemd/system/binance-futures-agent-outcome-reconcile.service" ] || die "refusing unexpected outcome reconcile unit path"
  [ "$OUTCOME_RECONCILE_TIMER_PATH" = "/etc/systemd/system/binance-futures-agent-outcome-reconcile.timer" ] || die "refusing unexpected outcome reconcile timer path"
...
install_systemd_unit() {
  ...
  install -m 0644 "$APP_ROOT/app/deploy/systemd/binance-futures-agent-outcome-reconcile.service" "$OUTCOME_RECONCILE_UNIT_PATH"
  install -m 0644 "$APP_ROOT/app/deploy/systemd/binance-futures-agent-outcome-reconcile.timer" "$OUTCOME_RECONCILE_TIMER_PATH"
