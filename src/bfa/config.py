...
DEFAULTS = {
    ...
    "BFA_LIVE_MICRO_GRID_ASYNC_PENDING_ENABLED": "false",
    ...
    "BFA_LIVE_TREND_MAX_SIGNAL_AGE_SECONDS": "0",
...
NUMERIC_FIELDS = (
    ...
    "BFA_PENDING_LIMIT_MICRO_GRID_REPRICE_AFTER_SECONDS",
    "BFA_PENDING_LIMIT_MICRO_GRID_REPRICE_EDGE_BPS",
    "BFA_PENDING_LIMIT_MICRO_GRID_REPRICE_WAIT_SECONDS",
    "BFA_PENDING_LIMIT_MICRO_GRID_REPRICE_MAX_ATTEMPTS",
    "BFA_PENDING_LIMIT_MICRO_GRID_REPRICE_MAX_MARK_AGE_SECONDS",
    ...
    "BFA_POSITION_SENTINEL_TREND_LOSS_CONTROL_ADVERSE_VOLUME_RATIO",
    "BFA_POSITION_SENTINEL_TREND_LOSS_CONTROL_MAX_ALIGNMENT",
    "BFA_POSITION_SENTINEL_TREND_LOSS_CONTROL_NO_MFE_R",
