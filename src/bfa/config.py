...
DEFAULTS = {
    ...
    "BFA_PROTECTIVE_STOP_WORKING_TYPE": "MARK_PRICE",
    "BFA_PROTECTIVE_TARGET_WORKING_TYPE": "MARK_PRICE",
    "BFA_MICRO_GRID_STOP_WORKING_TYPE": "MARK_PRICE",
    "BFA_MICRO_GRID_TARGET_WORKING_TYPE": "CONTRACT_PRICE",
    ...
    "BFA_POSITION_SENTINEL_MICRO_COOLDOWN_SECONDS": "15",
    ...
    "BFA_POSITION_SENTINEL_TREND_EARLY_FAILURE_SHADOW_ENABLED": "true",
    "BFA_POSITION_SENTINEL_TREND_EARLY_FAILURE_MIN_SECONDS": "90",
    "BFA_POSITION_SENTINEL_TREND_EARLY_FAILURE_MAX_SECONDS": "900",
    "BFA_POSITION_SENTINEL_TREND_EARLY_FAILURE_MAX_MFE_R": "0.20",
    "BFA_POSITION_SENTINEL_TREND_EARLY_FAILURE_MIN_ADVERSE_R": "0.25",
    "BFA_POSITION_SENTINEL_TREND_EARLY_FAILURE_MIN_VOTES": "3",
    "BFA_POSITION_SENTINEL_TREND_EARLY_FAILURE_VOLUME_EXPANSION_RATIO": "1.30",
    ...
    "BFA_POSITION_EXCURSION_HEARTBEAT_SECONDS": "300",
    ...
    "BFA_PENDING_LIMIT_QUALITY_ADVERSE_TAKER_BUY_FRACTION": "0.35",
    "BFA_PENDING_LIMIT_QUALITY_VOLUME_EXPANSION_RATIO": "1.5",
    ...
    "BFA_LIVE_MICRO_GRID_COST_QUALITY_SHADOW_ENABLED": "true",
    "BFA_LIVE_MICRO_GRID_COST_QUALITY_ENFORCE_ENABLED": "false",
    "BFA_LIVE_MICRO_GRID_MIN_NET_REWARD_PERCENT": "0.30",
    "BFA_LIVE_MICRO_GRID_MAX_REVERSAL_RESPONSE_RATE": "0.90",
...
NUMERIC_FIELDS = (
    ...
    "BFA_PENDING_LIMIT_QUALITY_ADVERSE_TAKER_BUY_FRACTION",
    "BFA_PENDING_LIMIT_QUALITY_VOLUME_EXPANSION_RATIO",
    "BFA_PENDING_LIMIT_QUALITY_PRICE_ACCEPTANCE_RETURN_PERCENT",
    ...
    "BFA_DB_DECISION_SNAPSHOT_RETENTION_HOURS",
    "BFA_DB_SENTINEL_EVENT_RETENTION_HOURS",
    "BFA_DB_MAINTENANCE_BATCH_SIZE",
    "BFA_DB_MAINTENANCE_MAX_DELETE_ROWS",
    "BFA_DB_HIGH_FREQUENCY_RETENTION_BATCH_SIZE",
    "BFA_DB_HIGH_FREQUENCY_RETENTION_MAX_DELETE_ROWS",
    ...
    "BFA_LIVE_MICRO_GRID_MIN_NET_REWARD_PERCENT",
    "BFA_LIVE_MICRO_GRID_MAX_REVERSAL_RESPONSE_RATE",
    ...
    "BFA_POSITION_SENTINEL_MICRO_COOLDOWN_SECONDS",
    ...
    "BFA_POSITION_SENTINEL_FULL_HEARTBEAT_SECONDS",
    "BFA_POSITION_SENTINEL_DELTA_HEARTBEAT_SECONDS",
    ...
    "BFA_POSITION_SENTINEL_TREND_EARLY_FAILURE_MIN_SECONDS",
    "BFA_POSITION_SENTINEL_TREND_EARLY_FAILURE_MAX_SECONDS",
    "BFA_POSITION_SENTINEL_TREND_EARLY_FAILURE_MAX_MFE_R",
    "BFA_POSITION_SENTINEL_TREND_EARLY_FAILURE_MIN_ADVERSE_R",
    "BFA_POSITION_SENTINEL_TREND_EARLY_FAILURE_VOLUME_EXPANSION_RATIO",
    "BFA_POSITION_EXCURSION_HEARTBEAT_SECONDS",
...
INTEGER_FIELDS = (
    ...
    "BFA_PENDING_LIMIT_QUALITY_ADVERSE_MIN_WINDOWS",
    "BFA_LIMIT_ENTRY_DEFER_MIN_WAIT_SECONDS",
    "BFA_POSITION_SENTINEL_TREND_EARLY_FAILURE_MIN_VOTES",
...
def validate_config(config: AppConfig) -> ValidationResult:
    ...
    for key in (
        "BFA_PROTECTIVE_STOP_WORKING_TYPE",
        "BFA_PROTECTIVE_TARGET_WORKING_TYPE",
        "BFA_MICRO_GRID_STOP_WORKING_TYPE",
        "BFA_MICRO_GRID_TARGET_WORKING_TYPE",
    ):
        if config.get(key).strip().upper() not in {"MARK_PRICE", "CONTRACT_PRICE"}:
            errors.append(f"{key} must be MARK_PRICE or CONTRACT_PRICE")
