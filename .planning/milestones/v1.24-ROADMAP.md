...
Archived on 2026-06-21. Live automation remains paused: the Phase 55 operator
packet currently returns `resolve_exposure`, not live eligibility, with
manual/unattributed `ETHUSDT` and `BTWUSDT` exposure plus insufficient guarded
paper evidence.
