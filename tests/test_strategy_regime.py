...
class StrategyRegimeRouterTests(unittest.TestCase):
    ...
    def test_clean_trend_width_expansion_still_routes_to_trend(self):
        decision = classify_regime(
            {
                "range_path_efficiency": 0.68,
                "range_edge_alternation_count": 0,
                "range_width_percent": 1.8,
                "range_stable_width_percent": 0.75,
                "ema_spread_percent": 0.22,
                "kline_momentum_percent": 1.05,
                "kline_micro_momentum_percent": 0.16,
                "kline_quote_volume_change_percent": 92.0,
                "kline_close_position_percent": 74.0,
            },
            strategy_leg="trend",
            shadow_only=False,
        )
        ...
        self.assertEqual(decision.label, TREND)
        self.assertEqual(decision.route_decision, "allow")
        self.assertNotIn("regime_range_width_expanding", decision.reason_codes)
