...
class MicroGridLiveAdapterTests(unittest.TestCase):
    ...
    def test_live_profile_uses_entry_depth_overrides_from_config(self):
        live_config = MicroGridLiveConfig.from_app(
            load_config(
                env={
        ...
        self.assertEqual(profile.dynamic_entry_base_edge_fraction, -0.03)
        self.assertEqual(profile.dynamic_entry_max_push_fraction, 0.12)
        self.assertEqual(profile.dynamic_entry_flow_push_fraction, 0.04)
        self.assertEqual(profile.dynamic_entry_momentum_push_fraction, 0.04)
        self.assertEqual(profile.dynamic_entry_volatility_push_fraction, 0.025)
        self.assertEqual(profile.dynamic_entry_wick_push_fraction, 0.03)
        self.assertEqual(profile.dynamic_entry_continuation_push_fraction, 0.025)
        self.assertEqual(profile.wick_min_entry_fraction, -0.42)
        self.assertEqual(profile.spike_depth_entry_fraction, 0.48)
        self.assertEqual(profile.spike_depth_tail_buffer_fraction, 0.10)
        self.assertEqual(profile.spike_depth_max_entry_edge_fraction, -0.42)
